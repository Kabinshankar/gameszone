...
export default function GamesLibraryClient() {
  ...
  const [, setRecentlyPlayed] = useState<RecentGame[]>([]);
    ...
    <Container className="py-12 sm:py-16 flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white">
          Free Online Games Directory
        </h1>
        <p className="text-sm text-zinc-400 max-w-2xl">
          Browse and play our full collection of {games.length} free browser games. Instant play with zero downloads or installs required.
        </p>
      </div>
