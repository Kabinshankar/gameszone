...
- **Next.js**: MIT License (Copyright © Vercel, Inc.)
- **React**: MIT License (Copyright © Meta Platforms, Inc.)
- **Tailwind CSS**: MIT License (Copyright © Tailwind Labs, Inc.)
- **Lucide React Icons**: ISC License (Copyright © Lucide Contributors)
- **Framer Motion**: MIT License (Copyright © Framer)
